...
$$
\begin{equation}
U_{a} = U_{0}\left(1-e^{\frac{1}{C\,R_{i}}t}\right),
\end{equation}
$$
die Sie über die Messanordnung bestimmen können. Aus dem Verlauf derEntladekurve läßt sich $R_{i}$ bei Kenntnis von $C$ bestimmen.
